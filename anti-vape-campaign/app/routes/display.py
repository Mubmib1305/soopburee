...
# ไฟล์นี้จัดการเส้นทาง (routes) สำหรับส่วนแสดงผลบนหน้าจอขนาดใหญ่
# ทำหน้าที่:
# 1. กำหนดเส้นทางสำหรับหน้าแสดงผลต่างๆ:
#    - /qrcode: แสดง QR code สำหรับให้ผู้ใช้งานสแกนเข้าสู่ระบบ
#    - /anatomy: แสดงภาพกายวิภาคร่างกาย
#    - /messages: แสดงข้อความที่ผู้ใช้ได้แสดงความคิดเห็น
#    - /emoji: แสดงอิโมจิหรือดอกไม้ที่ผู้ใช้เลือก
# 2. มี API endpoint ที่ /api/messages/active เพื่อให้หน้า frontend สามารถดึงข้อมูลล่าสุด
#    จากฐานข้อมูล Supabase มาแสดงผลแบบเรียลไทม์
# 3. จัดการข้อผิดพลาดที่อาจเกิดขึ้นระหว่างการดึงข้อมูลและส่งคืนผลลัพธ์ที่เหมาะสม