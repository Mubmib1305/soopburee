...
// ไฟล์นี้เป็น JavaScript หลักสำหรับส่วนแสดงผลหน้าจอขนาดใหญ่
// ทำหน้าที่:
// 1. จัดการการเชื่อมต่อกับ API และดึงข้อมูลล่าสุดจากเซิร์ฟเวอร์:
//    - fetchData(): ฟังก์ชันกลางในการดึงข้อมูลจาก API
// 2. ควบคุมการแสดงผลสามส่วนหลัก ผ่านคลาสต่างๆ:
//    - AnatomyController: ควบคุมการแสดงผลส่วนกายวิภาคร่างกาย
//    - MessagesController: ควบคุมการแสดงผลข้อความจากผู้ใช้งาน
//    - EmojiController: ควบคุมการแสดงผลอิโมจิและดอกไม้
// 3. จัดการเอฟเฟกต์การแสดงผลแบบเรียลไทม์:
//    - การเปลี่ยนสีของภาพกายวิภาคตามจำนวนข้อความ
//    - การเคลื่อนไหวของอิโมจิและดอกไม้
//    - การแสดงข้อความแบบสลับเปลี่ยนอัตโนมัติ
// 4. มีฟังก์ชันเริ่มต้นสำหรับแต่ละหน้า:
//    - initAnatomyPage(): เริ่มต้นหน้ากายวิภาค
//    - initMessagesPage(): เริ่มต้นหน้าข้อความ
//    - initEmojiPage(): เริ่มต้นหน้าอิโมจิ